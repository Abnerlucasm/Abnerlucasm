[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=c9d1d9&size=35&center=true&vCenter=true&width=1000&lines=Olá,+meu+nome+é+Abner+Lucas;Tenho+22+anos;Sou+do+Brasil+🇧🇷;Desenvolvedor+Full+Stack;Java+%7C+React+%7C+TypeScript;Bem-vindo!+😊&font=JetBrains+Mono+Nerd+Font)](https://git.io/typing-svg)
...
```bash
$ whoami
Desenvolvedor Full Stack na Neo Sistemas, cursando o último ano de Sistemas de Informação
na UNIBAVE. Atuo no desenvolvimento e manutenção de soluções ERP com Java, JSF, React e
TypeScript. Minha trajetória de quase 4 anos na mesma empresa — passando por Suporte,
Implantação e agora Desenvolvimento — me deu uma visão completa dos sistemas e dos
processos de negócio. Também trabalho com Python, PostgreSQL e tenho background em
design gráfico e AutoCAD.

$ missão
Construir soluções bem estruturadas, alinhadas ao negócio, e continuar evoluindo como
...
<p align="center">
  ...
  <a href="mailto:abnerlucas.m@gmail.com">
...
<table>
  <tr>
    ...
    <td>
      ...
      <p><a href="https://www.neosistemas.com.br">Neo Sistemas</a> • Nov 2025 – Presente</p>
      <p><strong>Stack:</strong> Java · JSF · React · TypeScript · PostgreSQL</p>
      <p>Desenvolvimento e manutenção de sistemas ERP corporativos. Implementação de funcionalidades, interfaces e regras de negócio, com colaboração entre equipes técnicas e funcionais.</p>
    </td>
  </tr>
  <tr>
    <td width="80px" align="center" valign="top">
    ...
    <td>
      ...
      <p><a href="https://www.neosistemas.com.br">Neo Sistemas</a> • Set 2023 – Out 2025</p>
      <p><strong>Stack:</strong> PostgreSQL · JavaScript · Delphi · SQL</p>
      <p>Implantação de módulos ERP, análise de processos, parametrização, levantamento de requisitos e suporte durante a transição dos clientes.</p>
    </td>
  </tr>
  <tr>
    <td width="80px" align="center" valign="top">
    ...
    <td>
      ...
      <p><a href="https://www.neosistemas.com.br">Neo Sistemas</a> • Jun 2022 – Set 2023</p>
      <p><strong>Stack:</strong> PostgreSQL</p>
      <p>Suporte a usuários de ERP: atendimento de chamados, análise de incidentes e orientação operacional.</p>
    </td>
  </tr>
  <tr>
    <td width="80px" align="center" valign="top">
    ...
    <td>
      <h3>Social Media Pleno</h3>
      <p><a href="https://www.praqnome.com.br">Praqnome</a> • Jul 2020 – Jun 2022</p>
      <p><strong>Stack:</strong> Adobe Illustrator · Photoshop · InDesign · After Effects · Premiere Pro</p>
      <p>Direção de arte para e-commerce e redes sociais em varejista têxtil.</p>
    </td>
  </tr>
</table>
...
## <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Open%20Book.png" width="25" /> Também trabalho com
